...
<section class="banner grey-banner">
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Building insurance</li>
    </ol>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 content-container">
        <img class="headerimg" src="/assets/img/insurance.png">
