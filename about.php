...
<section class="banner white-banner">
  <div class="container text-center">
    ...
    <h1>As a property consultanc company, we work <br>with clients in a number of different areas:</h1>
    <div class="button-block">
      <a class="btn btn-olive btn-block" href="#">
        <p><strong>Commercial <br>Property Management</strong></p>
        <p>Facilities management</p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <p><strong>Residential <br>Block Management</strong></p>
        <p>service charge <br>management</p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <br>
        <p><strong>Residential <br>property sales &amp; <br> Acquisitions</strong></p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <br>
        <p><strong>Residential <br>Property Lettings</strong></p>
      </a>
    </div>
    ...
    <div class="button-block">
      <a class="btn btn-olive btn-block" href="#">
        <br>
        <p><strong>Commercial Property <br>Letting, Sales &amp;<br> Acquisitions</strong></p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <br>
        <p><strong>Cost Consultancy, <br>Dilapidations Repairs<br> and Maintenance.</strong></p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <p><strong>Buildings<br>Insurance<br> Acquisitions</strong></p>
        <p>FSA registered</p>
      </a>
      <a class="btn btn-olive btn-block" href="#">
        <p><strong>Professional <br>Services</strong></p>
        <p>Valuations, appraisal<br>reports, rent review and <br> lease renewal</p>
      </a>
    </div>
  </div>
</section>
