...
<section class="banner grey-banner">
  <div class="container">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">Dilapidations maintenance</li>
    </ol>
  </div>
</section>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-8 content-container">
        <img class="headerimg" src="/assets/img/dilap-and-maint.png">
        ...
        <ul>
          <li>Comprehensive reports on building issues and defects</li>
          <li>Budget estimation </li>
          <li>Data management </li>
          <li>Cost monitoring </li>
          <li>Building work and supervision </li>
        </ul>
        <p>We also prepare schedules of dilapidations on behalf of landlords and insure compliance with lease terms.
